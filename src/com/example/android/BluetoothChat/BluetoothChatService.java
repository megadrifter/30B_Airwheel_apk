...
public class BluetoothChatService
{
  ...
  private void connectionFailed()
  {
    ...
    localBundle.putString("toast", "Connection failed, please try again");
  ...
  private void connectionLost()
  {
    Message localMessage = this.mHandler.obtainMessage(5);
    Bundle localBundle = new Bundle();
    localBundle.putString("toast", "Bluetooth disconnected");
    localMessage.setData(localBundle);
    this.mHandler.sendMessage(localMessage);
    start();
  }
    ...
    extends Thread
  {
    ...
    public void run()
    {
      ...
      //   11: aload_0
      //   12: getfield 30	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mSocketType	Ljava/lang/String;
      ...
      //   35: aload_0
      //   36: getfield 30	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mSocketType	Ljava/lang/String;
      ...
      //   45: invokevirtual 97	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:setName	(Ljava/lang/String;)V
      //   48: aload_0
      //   49: getfield 21	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:this$0	Lcom/example/android/BluetoothChat/BluetoothChatService;
      //   52: invokestatic 101	com/example/android/BluetoothChat/BluetoothChatService:access$0	(Lcom/example/android/BluetoothChat/BluetoothChatService;)Landroid/bluetooth/BluetoothAdapter;
      //   55: invokevirtual 107	android/bluetooth/BluetoothAdapter:cancelDiscovery	()Z
      //   58: pop
      //   59: aload_0
      //   60: getfield 42	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mmSocket	Landroid/bluetooth/BluetoothSocket;
      //   63: invokevirtual 110	android/bluetooth/BluetoothSocket:connect	()V
      //   66: aload_0
      //   67: getfield 21	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:this$0	Lcom/example/android/BluetoothChat/BluetoothChatService;
      //   70: astore_1
      //   71: aload_1
      //   72: monitorenter
      //   73: aload_0
      //   74: getfield 21	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:this$0	Lcom/example/android/BluetoothChat/BluetoothChatService;
      //   77: aconst_null
      //   78: invokestatic 114	com/example/android/BluetoothChat/BluetoothChatService:access$5	(Lcom/example/android/BluetoothChat/BluetoothChatService;Lcom/example/android/BluetoothChat/BluetoothChatService$ConnectThread;)V
      //   81: aload_1
      //   82: monitorexit
      //   83: aload_0
      //   84: getfield 21	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:this$0	Lcom/example/android/BluetoothChat/BluetoothChatService;
      //   87: aload_0
      //   88: getfield 42	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mmSocket	Landroid/bluetooth/BluetoothSocket;
      //   91: aload_0
      //   92: getfield 26	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mmDevice	Landroid/bluetooth/BluetoothDevice;
      //   95: aload_0
      //   96: getfield 30	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mSocketType	Ljava/lang/String;
      //   99: invokevirtual 118	com/example/android/BluetoothChat/BluetoothChatService:connected	(Landroid/bluetooth/BluetoothSocket;Landroid/bluetooth/BluetoothDevice;Ljava/lang/String;)V
      //   102: return
      //   103: astore_1
      //   104: aload_0
      //   105: getfield 42	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mmSocket	Landroid/bluetooth/BluetoothSocket;
      //   108: invokevirtual 82	android/bluetooth/BluetoothSocket:close	()V
      //   111: aload_0
      //   112: getfield 21	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:this$0	Lcom/example/android/BluetoothChat/BluetoothChatService;
      //   115: invokestatic 122	com/example/android/BluetoothChat/BluetoothChatService:access$4	(Lcom/example/android/BluetoothChat/BluetoothChatService;)V
      //   118: return
      //   119: astore_1
      //   120: ldc 52
      ...
      //   131: aload_0
      //   132: getfield 30	com/example/android/BluetoothChat/BluetoothChatService$ConnectThread:mSocketType	Ljava/lang/String;
...
/* Location:              C:\_my\Airwheel\Приложение\Gotway_En\copy_com.kebye.android.gotwaybluetooth-2\classes-dex2jar.jar!\com\example\android\BluetoothChat\BluetoothChatService.class
